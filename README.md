...
- [Chess with Jev](https://chriswijnia.com/experiments/chess) - Jev chooses one move per turn from the legal moves, each described with facts worked out in code (exchanges, mates, threats); the page plays it and draws Jev's candidates as arrows.
