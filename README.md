...
- [neurolink](https://github.com/juspay/neurolink) - The pipe layer of an AI nervous system: TypeScript SDK connecting provider neurons — including TypeSafe Jev and Laya for `decide` — to an application across generate/stream/decide.
