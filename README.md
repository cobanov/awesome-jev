...
- [RSI-Jev](https://github.com/Shanghua-Gao/RSI-Jev) - Open 0.8B and 2B models that answer Choice, Score, and Noul on the same `POST /v1/systemone` wire format in one forward pass, trained by a self-improving loop of agents that publishes every experiment it ran, including the ones that failed.
